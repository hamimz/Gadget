...
const router = require('./productsList');
...
describe('ProductsList routes', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  test('GET /productsList - authorized user', async () => {
    ...
    const response = await request(app).get('/productsList');

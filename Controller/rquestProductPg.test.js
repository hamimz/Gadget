...
const router = require('./requestProductPg');
...
describe('RequestProductPg routes', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  test('GET /requestProductPg - authorized user', async () => {
    ...
    const response = await request(app).get('/requestProductPg');
